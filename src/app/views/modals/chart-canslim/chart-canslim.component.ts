...
@Component({
  selector: "app-chart-canslim",
  templateUrl: "./chart-canslim.component.html",
  styleUrls: ["./chart-canslim.component.scss"],
})
export class ChartCanslimComponent implements OnInit, AfterViewInit {
